...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Score = __webpack_require__(1);
	...
	var _Identification = __webpack_require__(4);
	
	var _Identification2 = _interopRequireDefault(_Identification);
	
	var _Part = __webpack_require__(5);
...
/***/ function(module, exports) {
	...
	var Defaults = (function () {
	  ...
	  _createClass(Defaults, [{
	    ...
	    key: 'getSystemLayout',
	    value: function getSystemLayout() {
	      return this.systemLayout;
	    }
	  }, {
	    key: 'getStaffLayoutMap',
	    value: function getStaffLayoutMap() {
	      return this.staffLayoutMap;
	    }
	  }, {
	    key: 'getPageSize',
	    ...
	    key: 'getPageMarginsMap',
	    value: function getPageMarginsMap() {
	      return this.pageLayout && this.pageLayout.pageMarginsMap ? this.pageLayout.pageMarginsMap : undefined;
	    }
	  }, {
	    key: 'getPageMargin',
	    value: function getPageMargin(pageNumber, pageMarginType) {
	      var pageMarginsMap = this.getPageMarginsMap();
	      var defaultMargin = Defaults.PAGE_MARGINS[pageMarginType];
	
	      if (!pageMarginsMap) return defaultMargin;
	
	      var pageMargins = pageMarginsMap.has('both') ? pageMarginsMap.get('both') : pageMarginsMap.get(pageNumber % 2 === 0 ? 'even' : 'odd');
	
	      return pageMargins && pageMargins[pageMarginType] !== undefined ? pageMargins[pageMarginType] : defaultMargin;
	    }
	  }, {
	    key: 'getPageLeftMargin',
	    value: function getPageLeftMargin(pageNumber) {
	      return this.getPageMargin(pageNumber, 'leftMargin');
	    }
	  }, {
	    key: 'getPageRightMargin',
	    value: function getPageRightMargin(pageNumber) {
	      return this.getPageMargin(pageNumber, 'rightMargin');
	    }
	  }, {
	    key: 'getPageTopMargin',
	    value: function getPageTopMargin(pageNumber) {
	      return this.getPageMargin(pageNumber, 'topMargin');
	    }
	  }, {
	    key: 'getPageBottomMargin',
	    value: function getPageBottomMargin(pageNumber) {
	      return this.getPageMargin(pageNumber, 'bottomMargin');
	    }
	  }, {
	    key: 'getSystemMargins',
	    value: function getSystemMargins() {
	      return this.systemLayout && this.systemLayout.systemMargins ? this.systemLayout.systemMargins : undefined;
	    }
	  }, {
	    key: 'getSystemMargin',
	    value: function getSystemMargin(systemMarginType) {
	      var systemMargins = this.getSystemMargins();
	      return systemMargins ? systemMargins[systemMarginType] : Defaults.SYSTEM_MARGINS[systemMarginType];
	    }
	  }, {
	    key: 'getSystemLeftMargin',
	    value: function getSystemLeftMargin() {
	      return this.getSystemMargin('leftMargin');
	    }
	  }, {
	    key: 'getSystemRightMargin',
	    value: function getSystemRightMargin() {
	      return this.getSystemMargin('rightMargin');
	    }
	  }, {
	    key: 'getTopSystemDistance',
	    value: function getTopSystemDistance() {
	      return this.systemLayout && this.systemLayout.topSystemDistance !== undefined ? this.systemLayout.topSystemDistance : Defaults.TOP_SYSTEM_DISTANCE;
	    }
	  }, {
	    key: 'getSystemDistance',
	    value: function getSystemDistance() {
	      return this.systemLayout && this.systemLayout.systemDistance !== undefined ? this.systemLayout.systemDistance : Defaults.SYSTEM_DISTANCE;
	    }
	  }, {
	  ...
	  _createClass(Part, [{
	    ...
	    value: function getNumStaffs() {
	      ...
	      this.measures.forEach(function (measure) {
	        _this.numStaffs = Math.max(_this.numStaffs, measure.getNumStaffs());
	      });
	    ...
	    key: "getVFTies",
	    value: function getVFTies(key) {
	      if (key === undefined) return [].concat(_toConsumableArray(this.vfTiesMap.values())).reduce(function (a, b) {
	        return a.concat(b);
	      }, []);
	    ...
	    key: "setVFTiesMap",
	    value: function setVFTiesMap(vfTiesMap) {
	      this.vfTiesMap = vfTiesMap;
	    }
	  }, {
	    key: "getVFSlurs",
	    value: function getVFSlurs(key) {
	      if (key === undefined) return [].concat(_toConsumableArray(this.vfSlursMap.values())).reduce(function (a, b) {
	        return a.concat(b);
	      }, []);
	    ...
	    key: "setVFSlursMap",
	    value: function setVFSlursMap(vfSlursMap) {
	      this.vfSlursMap = vfSlursMap;
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	var Measure = (function () {
	  ...
	  _createClass(Measure, [{
	    key: "getPrint",
	    value: function getPrint() {
	      return this.print;
	    }
	  }, {
	    key: "hasPrint",
	    value: function hasPrint() {
	      return this.print ? true : false;
	    }
	  }, {
	    key: "hasNewSystem",
	    value: function hasNewSystem() {
	      return this.print && this.print.newSystem ? true : false;
	    }
	  }, {
	    key: "hasNewPage",
	    value: function hasNewPage() {
	      return this.print && this.print.newPage ? true : false;
	    }
	  }, {
	    key: "hasTopSystemDistance",
	    value: function hasTopSystemDistance() {
	      var systemLayout = this.getSystemLayout();
	      return systemLayout && systemLayout.topSystemDistance !== undefined;
	    }
	  }, {
	    key: "hasSystemDistance",
	    value: function hasSystemDistance() {
	      var systemLayout = this.getSystemLayout();
	      return systemLayout && systemLayout.systemDistance !== undefined;
	    }
	  }, {
	    key: "hasStaffDistances",
	    value: function hasStaffDistances() {
	      var staffLayoutMap = this.getStaffLayoutMap();
	      return staffLayoutMap && staffLayoutMap.size > 0;
	    }
	  }, {
	    key: "isNewLineStarting",
	    value: function isNewLineStarting() {
	    ...
	    value: function isStaffDisplayed() {
	      ...
	      var staffDetails = this.staffDetailsMap.get(staff);
	      return staffDetails && staffDetails.printObject !== undefined ? staffDetails.printObject : defaultValue;
	    }
	  }, {
	    ...
	    value: function getHeight() {
	      ...
	      for (var staff = 1; staff <= numStaffs; staff++) {
	        if (this.isStaffDisplayed(staff)) _numStaffs++;
	      }
	
	      return Measure.STAFF_HEIGHT * _numStaffs + staffDistance * Math.max(_numStaffs - 1, 0);
	    }
	  }, {
	    key: "getNumStaffs",
	    value: function getNumStaffs() {
	      var staffLayoutMap = this.getStaffLayoutMap();
	      return Math.max(this.staffs.length, staffLayoutMap ? staffLayoutMap.size : 1);
	    }
	  }, {
	    key: "getSystemLayout",
	    value: function getSystemLayout() {
	      return this.print && this.print.systemLayout ? this.print.systemLayout : undefined;
	    }
	  }, {
	    key: "getStaffLayoutMap",
	    value: function getStaffLayoutMap() {
	      return this.print && this.print.staffLayoutMap ? this.print.staffLayoutMap : undefined;
	    }
	  }, {
	    key: "getLeftMargin",
	    ...
	    key: "setStaffY",
	    value: function setStaffY(staff, y) {
	      this.staffYMap.set(staff, y);
	    }
	  }, {
	    key: "getStaves",
	    value: function getStaves() {
	      return [].concat(_toConsumableArray(this.staveMap.values()));
	    }
	  }, {
	    key: "getStaveMap",
	    value: function getStaveMap() {
	    ...
	    key: "getClefMap",
	    value: function getClefMap() {
	      return this.clefMap;
	    }
	  }, {
	    key: "setClefMap",
	    value: function setClefMap(clefMap) {
	      this.clefMap = clefMap;
	    }
	  }, {
	    key: "getClef",
	    value: function getClef() {
	      var staff = arguments.length <= 0 || arguments[0] === undefined ? 1 : arguments[0];
	      return this.clefMap.get(staff);
	    }
	  }, {
	    key: "setClef",
	    value: function setClef(staff, clef) {
	      this.clefMap.set(staff, clef);
	    }
	  }, {
	    key: "getDivisions",
	    ...
	    key: "setDivisions",
	    value: function setDivisions(divisions) {
	      this.divisions = divisions;
	    }
	  }, {
	    key: "getNotesMap",
	    ...
	    key: "getVFBeams",
	    value: function getVFBeams() {
	      return [].concat(_toConsumableArray(this.vfBeamsMap.values())).reduce(function (a, b) {
	        return a.concat(b);
	      }, []);
	    }
	  }, {
	    key: "getVFBeamsMap",
	    value: function getVFBeamsMap() {
	      return this.vfBeamsMap;
	    }
	  }, {
	    key: "setVFBeamsMap",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PartParser = __webpack_require__(8);
	
	var _LayoutParser = __webpack_require__(9);
	...
	var _Credit = __webpack_require__(12);
	
	var _Credit2 = _interopRequireDefault(_Credit);
	
	var _PartList = __webpack_require__(13);
	...
	var parseMovement = function parseMovement(scorePartwise) {
	  var titleNode = scorePartwise.getElementsByTagName('movement-title')[0];
	  var numberNode = scorePartwise.getElementsByTagName('movement-number')[0];
	
	  var title = titleNode ? titleNode.textContent : null;
	  var number = numberNode ? numberNode.textContent : null;
	...
	var parseIdentification = function parseIdentification(idNode) {
	  var encodingNode = idNode.getElementsByTagName('encoding')[0];
	  var rightsNode = idNode.getElementsByTagName('rights')[0];
	  var encodingDateNode = encodingNode.getElementsByTagName('encoding-date')[0];
	
	  var rights = rightsNode ? rightsNode.textContent : null;
	  var encodingDate = encodingDateNode ? encodingDateNode.textContent : null;
	  var softwareList = [].concat(_toConsumableArray(encodingNode.getElementsByTagName('software'))).map(function (node) {
	    return node.textContent;
	  });
	  var creatorList = [].concat(_toConsumableArray(idNode.getElementsByTagName('creator'))).map(function (node) {
	    return {
	  ...
	  return new _Identification2.default({
	    rights: rights,
	...
	var parseDefaults = function parseDefaults(defaultsNode) {
	  var scalingNode = defaultsNode.getElementsByTagName('scaling')[0];
	  var pageLayoutNode = defaultsNode.getElementsByTagName('page-layout')[0];
	  var systemLayoutNode = defaultsNode.getElementsByTagName('system-layout')[0];
	  var staffLayoutNodes = [].concat(_toConsumableArray(defaultsNode.getElementsByTagName('staff-layout')));
	  ...
	  if (pageLayoutNode) data.pageLayout = (0, _LayoutParser.parsePageLayout)(pageLayoutNode);
	
	  if (staffLayoutNodes) data.staffLayoutMap = (0, _LayoutParser.parseStaffLayout)(staffLayoutNodes);
	
	  if (systemLayoutNode) data.systemLayout = (0, _LayoutParser.parseSystemLayout)(systemLayoutNode);
	
	  return new _Defaults2.default(data);
	};
	
	var parseCredit = function parseCredit(creditNode) {
	  var typeNode = creditNode.getElementsByTagName('credit-type')[0];
	  var data = {
	  ...
	  data.wordsList = [].concat(_toConsumableArray(creditNode.getElementsByTagName('credit-words'))).map(function (node) {
	    var words = { content: node.textContent };
	  ...
	  return new _Credit2.default(data);
	};
	
	var parsePartList = function parsePartList(partListNode) {
	  var scoreParts = [].concat(_toConsumableArray(partListNode.getElementsByTagName('score-part'))).map(function (node) {
	    var scoreInstNode = node.getElementsByTagName('score-instrument')[0];
	  ...
	  var partGroups = [];
	  var partGroupMap = new Map();
	  var pi = 0;
	
	  [].concat(_toConsumableArray(partListNode.childNodes)).forEach(function (node) {
	    if (node.tagName === 'part-group') {
	      var type = node.getAttribute('type');
	      var number = Number(node.getAttribute('number'));
	      if (type === 'stop') {
	        var _partGroup = partGroupMap.get(number);
	        _partGroup.stopPartIndex = pi - 1;
	        partGroups.push(_partGroup);
	        return;
	      }
	
	      var groupSymbolNode = node.getElementsByTagName('group-symbol')[0];
	      var groupNameNode = node.getElementsByTagName('group-name')[0];
	      var groupAbbreviationNode = node.getElementsByTagName('group-abbreviation')[0];
	      var groupBarlineNode = node.getElementsByTagName('group-barline')[0];
	      var partGroup = {
	        number: number,
	        startPartIndex: pi
	      };
	
	      if (groupSymbolNode) partGroup.groupSymbol = groupSymbolNode.textContent;
	
	      if (groupNameNode) partGroup.groupName = groupNameNode.textContent;
	
	      if (groupAbbreviationNode) partGroup.groupAbbreviation = groupAbbreviationNode.textContent;
	
	      if (groupBarlineNode) partGroup.groupBarline = groupBarlineNode.textContent === 'yes';
	...
	var parseCredits = function parseCredits(creditNodes) {
	  return creditNodes.map(function (node) {
	    return parseCredit(node);
	  });
	};
	
	var parseParts = function parseParts(partNodes) {
	  return partNodes.map(function (node) {
	    return (0, _PartParser.parsePart)(node);
	  });
	};
	...
	var parse = exports.parse = function parse(doc) {
	  ...
	  var movement = parseMovement(scorePartwise);
	  var identification = parseIdentification(scorePartwise.getElementsByTagName('identification')[0]);
	  var defaults = parseDefaults(scorePartwise.getElementsByTagName('defaults')[0]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ClefNote = __webpack_require__(11);
	...
	var parsePrint = function parsePrint(data, printNode) {
	  var print = {};
	  var measureNumberingNode = printNode.getElementsByTagName('measure-numbering')[0];
	  var systemLayoutNode = printNode.getElementsByTagName('system-layout')[0];
	  var staffLayoutNodes = [].concat(_toConsumableArray(printNode.getElementsByTagName('staff-layout')));
	
	  if (printNode.getAttribute('new-page') === 'yes') print.newPage = true;else if (printNode.getAttribute('new-system') === 'yes') print.newSystem = true;
	
	  if (measureNumberingNode) print.measureNumbering = measureNumberingNode.textContent;
	
	  if (systemLayoutNode) print.systemLayout = (0, _LayoutParser.parseSystemLayout)(systemLayoutNode);
	
	  if (staffLayoutNodes.length > 0) print.staffLayoutMap = (0, _LayoutParser.parseStaffLayout)(staffLayoutNodes);
	...
	var parseAttributes = function parseAttributes(data, attrNode, state) {
	  [].concat(_toConsumableArray(attrNode.childNodes)).forEach(function (node) {
	    switch (node.tagName) {
	      case 'divisions':
	      ...
	      case 'time':
	        ...
	        if (node.hasAttribute('symbol')) data.time.symbol = node.getAttribute('symbol');
	
	        break;
	      case 'key':
	        var cancelNode = node.getElementsByTagName('cancel')[0];
	        var modeNode = node.getElementsByTagName('mode')[0];
	        data.key = {
	        ...
	        break;
	      case 'clef':
	        var staff = node.hasAttribute('number') ? Number(node.getAttribute('number')) : state.staff;
	        var lineNode = node.getElementsByTagName('line')[0];
	        var clefOctaveChangeNode = node.getElementsByTagName('clef-octave-change')[0];
	        var clef = {
	          sign: node.getElementsByTagName('sign')[0].textContent
	        };
	
	        if (lineNode) clef.line = Number(lineNode.textContent);
	
	        if (clefOctaveChangeNode) clef.clefOctaveChange = Number(clefOctaveChangeNode.textContent);
	
	        if (!state.noteBegin) {
	          data.clefMap.set(staff, clef);
	        } else {
	          clef.tag = 'clef';
	          data.notesMap.get(state.voice).push(new _ClefNote2.default(clef));
	        }
	
	        break;
	      case 'staff-details':
	        var staffSizeNode = node.getElementsByTagName('staff-size')[0];
	        var staffDetails = {};
	
	        if (node.hasAttribute('print-object')) staffDetails.printObject = node.getAttribute('print-object') === 'yes';
	
	        staffDetails.number = node.hasAttribute('number') ? Number(node.getAttribute('number')) : 1;
	
	        if (staffSizeNode) staffDetails.staffSize = Number(staffSizeNode.textContent);
	...
	var parseNoteNotations = function parseNoteNotations(note, head, notationsNode) {
	  ...
	  if (slurNodes.length > 0) {
	    var slurNode = slurNodes[0]; // support only single slur
	...
	var parseNote = function parseNote(data, noteNode, state) {
	  ...
	  var stemNode = noteNode.getElementsByTagName('stem')[0];
	  ...
	  var isNewVoice = data.voices.indexOf(voice) === -1;
	  ...
	  if (beamNodes.length > 0 && beamNodes[0].hasAttribute('number')) {
	    beamNodes.sort(function (prev, next) {
	...
	var parseNotes = function parseNotes(data, noteNodes) {
	  var state = {
	    onGrace: false,
	    onChord: false,
	    duration: 0,
	  ...
	  var getDuration = function getDuration(node) {
	    return Number(node.getElementsByTagName('duration')[0].textContent);
	  };
...
/***/ function(module, exports) {
	...
	var parseSystemLayout = exports.parseSystemLayout = function parseSystemLayout(node) {
	  var systemLayout = {};
	  var systemMarginsNode = node.getElementsByTagName('system-margins')[0];
	  var topSystemDistanceNode = node.getElementsByTagName('top-system-distance')[0];
	  var systemDistanceNode = node.getElementsByTagName('system-distance')[0];
	  ...
	  if (topSystemDistanceNode) systemLayout.topSystemDistance = Number(topSystemDistanceNode.textContent);
	
	  if (systemDistanceNode) systemLayout.systemDistance = Number(systemDistanceNode.textContent);
	
	  return systemLayout;
	};
	
	var parseStaffLayout = exports.parseStaffLayout = function parseStaffLayout(nodes) {
	  var staffLayoutMap = new Map();
	
	  nodes.forEach(function (node) {
	    var staff = node.hasAttribute('number') ? Number(node.getAttribute('number')) : 1;
	...
	var parsePageLayout = exports.parsePageLayout = function parsePageLayout(layoutNode) {
	  var pageLayout = {
	  ...
	  [].concat(_toConsumableArray(layoutNode.getElementsByTagName('page-margins'))).forEach(function (node) {
	    var type = node.hasAttribute('type') ? node.getAttribute('type') : 'both';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Note2 = __webpack_require__(10);
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // Copyright (c) Taehoon Moon 2015.
	// @author Taehoon Moon
	
	var ClefNote = (function (_Note) {
	  _inherits(ClefNote, _Note);
	
	  function ClefNote(clef) {
	    _classCallCheck(this, ClefNote);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ClefNote).call(this, clef));
	
	    _this.sign = clef.sign;
	    _this.line = clef.line;
	    _this.clefOctaveChange = clef.clefOctaveChange;
	    return _this;
	  }
	  ...
	  _createClass(ClefNote, [{
	    ...
	    key: 'getClefOctaveChange',
	    value: function getClefOctaveChange() {
	  ...
	  _createClass(Formatter, [{
	    ...
	    value: function resetState() {
	      this.state = {
	        ...
	        staffDisplayedMap: new Map() };
	
	      // ${pi}/{staff}
	      var topSystemDistance = this.defaults.getTopSystemDistance();
	      var systemDistance = this.defaults.getSystemDistance();
	      var staffDistance = this.defaults.getStaffDistance();
	
	      for (var pi = 0; pi < this.state.numParts; pi++) {
	    ...
	    key: 'getMeasureCache',
	    value: function getMeasureCache(pi, mi) {
	      var key = pi + '/' + mi;
	      if (!this.measureCacheMap.has(key)) this.measureCacheMap.set(key, new _Measure2.default());
	
	      return this.measureCacheMap.get(key);
	    }
	  }, {
	    key: 'formatX',
	    value: function formatX() {
	      var _this = this;
	
	      this.state.pageNumber = 1;
	      var pageLeftMargin = this.defaults.getPageLeftMargin(this.state.pageNumber);
	      var systemLeftMargin = this.defaults.getSystemLeftMargin();
	
	      var x = 0;
	      this.parts.forEach(function (part, pi) {
	        part.getMeasures().forEach(function (measure, mi) {
	          var printMeasure = _this.parts[0].getMeasures()[mi];
	
	          if (printMeasure.hasNewPage()) _this.state.pageNumber++;
	
	          if (printMeasure.isNewLineStarting() || mi === 0) x = pageLeftMargin + printMeasure.getLeftMargin(systemLeftMargin);
	    ...
	    key: 'updateMeasureDistances',
	    value: function updateMeasureDistances(mi) {
	      var _this2 = this;
	      ...
	      this.parts.forEach(function (part, pi) {
	        ...
	        if (measure.hasTopSystemDistance()) _this2.state.topSystemDistanceMap.set(pi, measure.getTopSystemDistance());
	
	        if (measure.hasSystemDistance()) _this2.state.systemDistanceMap.set(pi, measure.getSystemDistance());
	
	        if (measure.hasStaffDistances()) {
	          [].concat(_toConsumableArray(measure.getStaffLayoutMap().keys())).forEach(function (staff) {
	            _this2.state.staffDistanceMap.set(pi + '/' + staff, measure.getStaffDistance(staff));
	          });
	        }
	      });
	    }
	    ...
	    key: 'updateMeasureYs',
	    value: function updateMeasureYs(_ref) {
	      var _this3 = this;
	
	      var aboveBottomY = _ref.aboveBottomY;
	      var mi = _ref.mi;
	
	      var measureTopYs = [];
	      var measureBottomYs = [];
	
	      var getDisplayed = function getDisplayed(pi, numStaffs) {
	        for (var staff = 1; staff <= numStaffs; staff++) {
	          if (_this3.state.staffDisplayedMap.get(pi + '/' + staff)) return true;
	        }
	      ...
	      this.parts.forEach(function (part, pi) {
	        ...
	        var topSystemDistance = _this3.state.topSystemDistanceMap.get(pi);
	        var pageTopMargin = _this3.defaults.getPageTopMargin(_this3.state.pageNumber);
	        var systemDistance = _this3.state.systemDistanceMap.get(pi);
	        var staffDistance = _this3.state.staffDistanceMap.get(pi + '/1');
	        var displayed = getDisplayed(pi, numStaffs);
	      ...
	      return { measureTopYs: measureTopYs, measureBottomYs: measureBottomYs };
	    }
	  }, {
	    key: 'updateStaffDisplayed',
	    value: function updateStaffDisplayed(mi) {
	      var _this4 = this;
	      ...
	      this.parts.forEach(function (part, pi) {
	        ...
	        for (var staff = 1; staff <= numStaffs; staff++) {
	          ...
	          if (staffDisplayed !== null) {
	            _this4.state.staffDisplayedMap.set(pi + '/' + staff, staffDisplayed);
	          }
	        }
	      });
	    }
	    ...
	    key: 'formatY',
	    value: function formatY() {
	      var _this5 = this;
	
	      this.state.pageNumber = 1;
	
	      var measureTopYs = [];
	      var measureBottomYs = [this.defaults.getPageTopMargin(this.state.pageNumber)];
	
	      var _loop = function _loop(mi) {
	        _this5.updateMeasureDistances(mi);
	
	        _this5.parts.forEach(function (part, pi) {
	          var numStaffs = part.getNumStaffs();
	          var measure = part.getMeasures()[mi];
	
	          if ((measure.isNewLineStarting() || mi === 0) && pi === 0) {
	            if (measure.hasNewPage()) _this5.state.pageNumber++;
	
	            _this5.updateStaffDisplayed(mi);
	
	            var _updateMeasureYs = _this5.updateMeasureYs({
	              aboveBottomY: measureBottomYs[measureBottomYs.length - 1],
	              mi: mi
	            });
	
	            measureTopYs = _updateMeasureYs.measureTopYs;
	            measureBottomYs = _updateMeasureYs.measureBottomYs;
	          }
	
	          var measureTopY = measureTopYs[pi];
	          for (var staff = 1; staff <= numStaffs; staff++) {
	            var key = pi + '/' + staff;
	            var staffDistance = _this5.state.staffDistanceMap.has(key) ? _this5.state.staffDistanceMap.get(key) : 0;
	
	            measure.setStaffY(staff, measureTopY + (_Measure2.default.STAFF_HEIGHT + staffDistance) * (staff - 1));
	            measure.setStaffDisplayed(staff, _this5.state.staffDisplayedMap.get(pi + '/' + staff));
	          }
	      ...
	      for (var mi = 0; mi < this.state.numMeasures; mi++) {
	        _loop(mi);
	      }
	    }
	  }, {
	    key: 'createStaves',
	    value: function createStaves() {
	      this.parts.forEach(function (part) {
	        ...
	        measures.forEach(function (measure, mi) {
	          if (measure.isNewLineStarting()) printMeasure = measure;
	    ...
	    key: 'formatMeasureNumber',
	    value: function formatMeasureNumber() {
	      var measureNumbering = 'system'; // default value
	
	      this.parts[0].getMeasures().forEach(function (measure, mi) {
	        var print = measure.getPrint();
	        if (print && print.measureNumbering) measureNumbering = print.measureNumbering;
	
	        var topStave = measure.getStaves()[0];
	        if (!topStave) return;
	
	        if (measureNumbering === 'measure' || measureNumbering === 'system' && measure.isNewLineStarting()) {
	        ...
	        part.getMeasures().forEach(function (measure, mi) {
	          ...
	          if (mi === 0 || measure.isNewLineStarting()) {
	            measure.getStaveMap().forEach(function (stave, staff) {
	              var vfClef = (0, _Util.getVFClef)(clefMap.get(staff));
	    ...
	    value: function formatKeySignature() {
	      ...
	      this.parts.forEach(function (part, pi) {
	        ...
	        part.getMeasures().forEach(function (measure, mi) {
	          ...
	          // update cache
	          _this7.getMeasureCache(pi, mi).setKey(key);
	          prevMeasure = measure;
	        });
	      });
	    }
	    ...
	    value: function formatTimeSignature() {
	      ...
	      this.parts.forEach(function (part, pi) {
	        ...
	        part.getMeasures().forEach(function (measure, mi) {
	          ...
	          // update cache
	          _this8.getMeasureCache(pi, mi).setTime(time);
	          prevMeasure = measure;
	        });
	      });
	    }
	    ...
	    value: function formatDivisions() {
	      ...
	      this.parts.forEach(function (part, pi) {
	        ...
	        part.getMeasures().forEach(function (measure, mi) {
	          ...
	          // update cache
	          _this9.getMeasureCache(pi, mi).setDivisions(divisions);
	        });
	      });
	    }
	  }, {
	      ...
	      this.credits.forEach(function (credit) {
	        ...
	        credit.getWordsList().forEach(function (words) {
	          ...
	          if (words.fontSize !== undefined) {
	            ...
	            _this10.context.attributes['font-size'] = fontSize; // svgcontext only
	          }
	
	          // default font: "times", no custom font support
	          text.attributes.set('font-family', 'times');
	          _this10.context.attributes['font-family'] = 'times';
	
	          var bbox = _this10.context.measureText(text.content);
	          _this10.context.restore();
	    ...
	    value: function formatPartList() {
	      ...
	      var findTopStave = function findTopStave(pi, mi, max) {
	        for (; pi < max; pi++) {
	          var staves = _this11.parts[pi].getMeasures()[mi].getStaves();
	      ...
	      var setText = function setText(_ref2) {
	        ...
	        var staveConnector = _ref2.staveConnector;
	        var text = _ref2.text;
	      ...
	      var _loop2 = function _loop2(mi) {
	        ...
	        partGroups.forEach(function (partGroup) {
	          ...
	          if (partGroup.groupSymbol) {
	            hasGroupSymbol = true;
	            var connectorType = (0, _Util.getVFConnectorType)(partGroup.groupSymbol);
	        ...
	        _this11.parts.forEach(function (part, pi) {
	    ...
	    */
	    ...
	    value: function _formatNote(note, clef, divisions) {
	      ...
	      var accidentals = [];
	      note.getHeads().forEach(function (_ref3) {
	        var step = _ref3.step;
	    ...
	    value: function formatTie() {
	      ...
	      this.parts.forEach(function (part) {
	        return _this15._formatTie(part);
	      });
	    }
	  }, {
	    key: '_formatSlur',
	    ...
	    value: function formatSlur() {
	      ...
	      this.parts.forEach(function (part) {
	        return _this16._formatSlur(part);
	      });
	    }
	  }, {
	    key: 'format',
	    ...
	    value: function renderVoices() {
	      ...
	      this.score.getParts().forEach(function (part, pi) {
	        ...
	        part.getMeasures().forEach(function (measure, mi) {
	          ...
	          measure.getVFVoices().forEach(function (voice) {
	            return voice.draw(context);
	          });
	        });
	      });
	    }
	    ...
	    value: function renderBeams() {
	      ...
	      this.score.getParts().forEach(function (part, pi) {
	        ...
	        part.getMeasures().forEach(function (measure, mi) {
	          ...
	          measure.getVFBeams().forEach(function (beam) {
...
;
//# sourceMappingURL=concerto.js.map